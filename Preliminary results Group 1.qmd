...
# l <- l[-which(l=="Avena fatua")]
l <- l[-which(l=="Erigeron annuus")]
# l <- l[-which(l=="Triticum aestivum")]
for(i in l) {
...
for(i in l) {
  ...
  d <- d[!is.na(d$Week),]
  model.aov <- 
    aov(Soil_humidity ~ Treatment * Week +                        Error(PlantId/(Treatment*Week)),data=d)
  s1 <- summary(model.aov)
  p.value.sh <- c(p.value.sh, 
                  s1[[1]][[1]]$`Pr(>F)`[1])
}

list.pvalues <- data.frame(l,p.value.ph,p.value.sh)
...
# st.rdw
# 
# variable <- st.ph$Mean.Plant.Height
# source("rmd/ANOVAmodel.R")
# an.ph
# 
# variable <- st.sh$Mean.Soil.Humidity
# source("rmd/ANOVAmodel.R")
# an.sh
# 
# variable <- st.ln$Mean.Leaf.Number
# source("rmd/ANOVAmodel.R")
# an.ln
# 
# variable <- st.cc$Mean.Chlorophyll.Content
# source("rmd/ANOVAmodel.R")
# an.cc
# 
# variable <- st.afw$Mean.Aerial.Fresh.Weight
# source("rmd/ANOVAmodel.R")
# an.afw
# 
# variable <- st.adw$Mean.Aerial.Dry.Weight
# source("rmd/ANOVAmodel.R")
# an.adw
# 
# variable <- st.rl$Mean.Root.Length
# source("rmd/ANOVAmodel.R")
# an.rl
# 
# variable <- st.rfw$Mean.Roots.Fresh.Weight
# source("rmd/ANOVAmodel.R")
# an.rfw
# 
# variable <- st.rdw$Mean.Roots.Dry.Weight
# source("rmd/ANOVAmodel.R")
# an.rdw
```
