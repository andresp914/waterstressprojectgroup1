...
labs(caption = "Figure 1. Mean plant height of the 15 plant species under three different water stress conditions.",
       x = "Week",
       y = "Plant height (cm)") +
...
theme(strip.text = element_text(face = "italic"))+
labs(caption = "Figure 2. Mean soil humidity of the 15 plant species under three different water stress conditions.",
       x = "Week",
       y = "Soil humidity (%)") +
  theme(plot.caption = element_text(hjust = 0), legend.position = "top", legend.box.background = element_rect(colour = "black"))
```
...
ggplot(meanleafnumber_byweeks, aes(x = Week, y = Mean_leaf_number, color = Treatment, group = Treatment)) +
  ...
  facet_wrap(~Species, scales = "free_y")+  # Facet by Species with free y-axis scales
theme(strip.text = element_text(face = "italic"))+
labs(caption = "Figure 3. Mean leaf number of the 15 plant species under three different water stress conditions.",
       x = "Week",
       y = "Leaf number") +
  theme(plot.caption = element_text(hjust = 0), legend.position = "top", legend.box.background = element_rect(colour = "black"))
```
...
ggplot(meanchlorophyll_byweeks, aes(x = Species, y = Mean_Chlorophyll, fill = Treatment, colour = Treatment)) +   geom_bar(stat = "identity", position = "dodge")+
  labs(caption = "Figure 4. Mean chlorophyll content of the 15 plant species under three different water stress conditions.",
       x = "Species",
...
ggplot(meanaerialfresh_byweeks, aes(x = Species, y = Mean_Aerialfresh, fill = Treatment, colour = Treatment)) +   geom_bar(stat = "identity", position = "dodge")+
  labs(caption = "Figure 5. Mean aerial fresh weight of the 15 plant species under three different water stress conditions.",
       x = "Species",
       y = "Aerial fresh weight (g)") +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0), axis.text.x = element_text(face="italic", angle = 60, vjust = 1, hjust=1))+
  scale_fill_brewer(palette="Set1") 
...
ggplot(meanaerialdry_byweeks, aes(x = Species, y = Mean_Aerialdry, fill = Treatment, colour = Treatment)) +   geom_bar(stat = "identity", position = "dodge")+
  labs(caption = "Figure 6. Mean aerial dry weight of the 15 plant species under three different water stress conditions.",
  x = "Species",
  y = "Aerial dry weight (g)") +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0), axis.text.x = element_text(face="italic", angle = 60, vjust = 1, hjust=1))+
  scale_fill_brewer(palette="Set1") 
```
...
ggplot(meanroot_lenght, aes(x = Species, y = Mean_Rootlength, fill = Treatment, colour = Treatment)) +   geom_bar(stat = "identity", position = "dodge")+
  labs(caption = "Figure 7. Mean root length of the 15 plant species under three different water stress conditions.",
  x = "Species",
  y = "Root length (cm)") +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0), axis.text.x = element_text(face="italic", angle = 60, vjust = 1, hjust=1))+
...
ggplot(meanroot_fresh, aes(x = Species, y = Mean_Rootfresh, fill = Treatment, colour = Treatment)) +   geom_bar(stat = "identity", position = "dodge")+
  labs(caption = "Figure 8. Mean roots fresh weight of the 15 plant species under three different water stress conditions.",
  x = "Species",
  y = "Roots fresh weight (g)") +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0), axis.text.x = element_text(face="italic", angle = 60, vjust = 1, hjust=1))+
  scale_fill_brewer(palette="Set1")
```
...
ggplot(meanroot_dry, aes(x = Species, y = Mean_Rootdry, fill = Treatment, colour = Treatment)) +   geom_bar(stat = "identity", position = "dodge")+
  labs(caption = "Figure 9. Mean roots dry weight of the 15 plant species under three different water stress conditions.",
  x = "Species",
  y = "Roots dry weight (g)") +
  theme_minimal() +
  theme(plot.caption = element_text(hjust = 0), axis.text.x = element_text(face="italic", angle = 60, vjust = 1, hjust=1))+
  scale_fill_brewer(palette="Set1")
```
