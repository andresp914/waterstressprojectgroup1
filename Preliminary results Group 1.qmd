...
pcadata <- newdata[c(4:7,11,12,16,19)]
...
#Working
mutate_all(pcadata(5:10), ~replace(pcadata, is.na(pcadata), 0)) #to change NA to 0
str(pcadata)
#Normalizing data
...
#biplot(stress.pcalotscores(pcadstress.atpcores(pcadata$Plant_height,pcadata$Chlorophyll_content)
#library(vegan)
