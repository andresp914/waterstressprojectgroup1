...
pcadata <- datahl[c(1,4:14)]
pcafinal <- fviz_pca_biplot(data.pca,
                            label="var",
                            habillage = pcadata$Species,
                            addEllipses=TRUE,
                            ellipse.level=0.95,
                            repel = TRUE)
pcafinal
...
#dataLr <- datahl[c(1,2,4:14)]
#datahl <- datahl[ which(datahl$Species=='Lolium rigidum'), ]
#dataLr <- datahl[c(2,4:14)]
# tabla Hordeum vulgare
#pcadataHv <- datahl[c(1,2,4:14)]
#pcadataHv <- pcadataHv[ which(pcadataHv$Species=='Hordeum vulgare'), ]
  # Lolium rigidum



#pcafinal4 <- fviz_pca_biplot(dataLr,
      #                      label="var",
     #                       habillage = dataLr$Treatment,
    #                        addEllipses=TRUE,
   #                         ellipse.level=0.95,
  #                          repel = TRUE,
 #                       )
#pcafinal4
#Hordeum vulgare
#pcadata2 <- pcadata[ which(pcadata$Species=='Hordeum vulgare'), ]
#pcafinal5 <- fviz_pca_biplot(data.pca,
 #                           label="var",
  #                          habillage = pcadata2$Treatment,
   #                         addEllipses=TRUE,
    #                        ellipse.level=0.95,
     #                       repel = TRUE,
      #                  )
